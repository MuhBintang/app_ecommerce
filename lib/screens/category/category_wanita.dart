...
class CategoryWanita extends StatefulWidget {
  const CategoryWanita({Key? key}) : super(key: key);

  @override
  State<CategoryWanita> createState() => _CategoryWanitaState();
}

class _CategoryWanitaState extends State<CategoryWanita> {
  List<Datum>? products;
  bool isLoading = true;
  String? id;
  ...
  Future<void> getProduct() async {
    try {
      http.Response res = await http.get(Uri.parse('$url/getCategorySendal.php'));
