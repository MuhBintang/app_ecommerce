...
class CategorySneaker extends StatefulWidget {
  const CategorySneaker({Key? key}) : super(key: key);

  @override
  State<CategorySneaker> createState() => _CategorySneakerState();
}

class _CategorySneakerState extends State<CategorySneaker> {
  List<Datum>? products;
  bool isLoading = true;
  String? id;
  ...
  Future<void> getProduct() async {
    try {
      http.Response res = await http.get(Uri.parse('$url/getCategorySneaker.php'));
