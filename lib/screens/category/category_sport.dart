...
class CategorySport extends StatefulWidget {
  const CategorySport({Key? key}) : super(key: key);

  @override
  State<CategorySport> createState() => _CategorySportState();
}

class _CategorySportState extends State<CategorySport> {
  List<Datum>? products;
  bool isLoading = true;
  String? id;
  ...
  Future<void> getProduct() async {
    try {
      http.Response res = await http.get(Uri.parse('$url/getCategorySport.php'));
