      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
                ...
                Column(
                  children: [
                    TextButton(
                      onPressed: () {
                        setState(() {
                          _selectedCategory = 0; // Mengatur kategori yang dipilih menjadi 0 (misalnya, "Home")
                        });
                      },
                      child: Text(
                        'Home',
                        style: TextStyle(color: _selectedCategory == 0 ? Color(0xFFEB3C3C) : Colors.black),
                      ),
                    ),
                    Container(
                      height: 2,
                      width: 50,
                      color: _selectedCategory == 0 ? Color(0xFFEB3C3C) : Colors.transparent,
                    ),
                  ],
                ),
                Column(
                  children: [
                    TextButton(
                      onPressed: () {
                        setState(() {
                          _selectedCategory = 1; // Mengatur kategori yang dipilih menjadi 1 (misalnya, "Category")
                        });
                      },
                      child: Text(
                        'Category',
                        style: TextStyle(color: _selectedCategory == 1 ? Color(0xFFEB3C3C) : Colors.black),
                      ),
                    ),
                    Container(
                      height: 2,
                      width: 50,
                      color: _selectedCategory == 1 ? Color(0xFFEB3C3C) : Colors.transparent,
                    ),
                  ],
                ),
              ],
            ),
            SizedBox(height: 20), // Add some space between the buttons and the carousel
            if (_selectedCategory == 1) // Menampilkan banner jika kategori yang dipilih adalah "Category"
              Column(
                children: [
            ...
            if (_selectedCategory == 0) // Hanya tampilkan Carousel jika kategori yang dipilih adalah "Home"
              CarouselSlider(
                carouselController: _carouselController,
                options: CarouselOptions(
                  autoPlay: true,
                  enlargeCenterPage: true,
                  aspectRatio: 36 / 16, // Sesuaikan dengan rasio aspek gambar Anda
            ...
            SizedBox(height: 20), // Add some space between the carousel and the new section
            if (_selectedCategory == 0) // Hanya tampilkan kategori "New Arrival" jika kategori yang dipilih adalah "Home"
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 20.0),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    ...
                    TextButton(
                      ...
                      child: Text(
                        'See all',
                        style: TextStyle(color: Color(0xFFEB3C3C)), // Warna huruf di "See all"
                      ),
                    ),
                  ],
                ),
